...
uint16_t adcConversionValue[ADCx_CHANNEL_NUM] = {0};
...
static void ADCx_Config(void)
{
	...
	ADC_RegularChannelConfig(ADC_x, ADCx_CHANNEL10, 6, ADCx_SAMPLETIME);
	ADC_RegularChannelConfig(ADC_x, ADCx_CHANNEL11, 5, ADCx_SAMPLETIME);
	ADC_RegularChannelConfig(ADC_x, ADCx_CHANNEL12, 4, ADCx_SAMPLETIME);
	ADC_RegularChannelConfig(ADC_x, ADCx_CHANNEL13, 3, ADCx_SAMPLETIME);
	ADC_RegularChannelConfig(ADC_x, ADCx_CHANNEL14, 2, ADCx_SAMPLETIME);
	ADC_RegularChannelConfig(ADC_x, ADCx_CHANNEL15, 1, ADCx_SAMPLETIME);
...
static void DMA_Config(void)
{
	...
	DMA_InitStruct.DMA_BufferSize = ADCx_CHANNEL_NUM;
